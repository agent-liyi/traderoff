...
const episodes = [
  {
    ...
    title: '当"效率"成为一种焦虑',
    guest: '张潇',
    description: '<p>这期我们聊了一个很多人都有感触的话题：为什么我们对"低效率"有那么强的负罪感？</p><p>张潇是一位独立咨询师，从大厂离开后，她花了很长时间才学会接受"慢下来"。我们聊了时间管理的迷思、休息的正当性，以及如何在"做得不够多"的感受中找到平静。</p>',
    transcript: '<h2>开场</h2><p><strong>李逸：</strong>大家好，欢迎来到动态平衡。今天请到的嘉宾是张潇，一位独立咨询师。潇姐，先跟大家打个招呼？</p><p><strong>张潇：</strong>大家好，很开心来到这里。</p><h2>离开大厂后的第一个月</h2><p><strong>李逸：</strong>你是什么时候离开上一份工作的？</p><p><strong>张潇：</strong>去年三月。离开之后第一个月，说实话我不知道该干什么。以前每天日程排满，突然一天没有会了，反而特别焦虑。</p><p><strong>李逸：</strong>那种焦虑具体是什么感觉？</p><p><strong>张潇：</strong>就是坐着看书会觉得自己在浪费时间。明明不用上班了，但还是有种"我应该在做点什么有产出的事"的压力。</p>',
    cover_image: null,
    duration: '62:30',
  ...
  },
  {
    ...
    guest: null,
    description: '<p>这是动态平衡的第一期节目，没有嘉宾，就是我自己聊聊为什么想做这档播客。</p><p>在快速变化的环境里，"平衡"不是一个终点，而是一种持续调整的能力。我想通过对话来探索这个主题——和不同的人聊聊他们是怎么在变化中找到自己节奏的。</p>',
    transcript: '<h2>开场</h2><p><strong>李逸：</strong>嗨，大家好。欢迎来到动态平衡的第一期。今天没有嘉宾，就是我自己来聊聊这档播客是怎么回事。</p><h2>为什么叫动态平衡</h2><p>这个名字来自化学里的一个概念。动态平衡不是静止的，而是两个方向的变化速率相等时呈现出的一种稳定状态。我觉得生活也是这样。</p><p>我们不太可能找到一个完美的平衡点然后一直待着不动。更现实的做法是学会不断调整——工作重了就多休息，社交多了就给自己独处的时间。这种持续的调整本身，就是平衡。</p>',
    cover_image: null,
    duration: '28:45',
